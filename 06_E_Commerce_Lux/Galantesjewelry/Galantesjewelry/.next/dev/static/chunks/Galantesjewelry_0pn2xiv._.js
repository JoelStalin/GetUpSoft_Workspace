...
"[project]/Galantesjewelry/lib/address-options.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Galantesjewelry/lib/product-image.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Galantesjewelry/lib/address-options.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$product$2d$image$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Galantesjewelry/lib/product-image.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function CheckoutPage() {
    ...
    const [customerData, setCustomerData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        ...
        state: '',
        zip: '',
        country: __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["US_COUNTRY"].label,
        state_id: undefined,
        country_id: __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["US_COUNTRY"].id
    });
    ...
    const cityOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CheckoutPage.useMemo[cityOptions]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCityOptions"])(customerData.state_id)
    }["CheckoutPage.useMemo[cityOptions]"], [
            ...
            async function loadCustomerCheckoutData() {
                try {
                    ...
                    if (profileResponse.ok) {
                        ...
                        const loadedState = profile.state_id?.[0] ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStateById"])(profile.state_id[0]) : null;
                        setCustomerData({
                            "CheckoutPage.useEffect.loadCustomerCheckoutData": (current)=>({
                                    ...
                                    country: current.country || __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["US_COUNTRY"].label,
                                    state_id: current.state_id || profile.state_id || undefined,
                                    country_id: current.country_id || profile.country_id || __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["US_COUNTRY"].id
                                })
    ...
    const applySavedAddress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CheckoutPage.useCallback[applySavedAddress]": (address)=>{
            const loadedState = address.state_id?.[0] ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStateById"])(address.state_id[0]) : null;
            ...
            setCustomerData({
                "CheckoutPage.useCallback[applySavedAddress]": (current)=>({
                        ...
                        zip: address.zip || '',
                        country: address.country_id?.[1] || __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["US_COUNTRY"].label,
    ...
    const persistCheckoutAddress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CheckoutPage.useCallback[persistCheckoutAddress]": async ()=>{
            ...
            const response = await fetch('/api/account/profile', {
                ...
                body: JSON.stringify({
                    ...
                    country_id: customerData.country_id || __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["US_COUNTRY"].id
                })
            });
            if (!response.ok) {
                const data = await response.json().catch({
                    "CheckoutPage.useCallback[persistCheckoutAddress]": ()=>({})
                }["CheckoutPage.useCallback[persistCheckoutAddress]"]);
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                ...
                                                                onChange: (e)=>{
                                                                    ...
                                                                    const nextState = Number.isFinite(nextStateId) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStateById"])(nextStateId) : null;
                                                                ...
                                                                children: [
                                                                    ...
                                                                    __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["US_STATE_OPTIONS"].map((state)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                            value: state.id,
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    cityOptions.map((city)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                            value: city,
                                                                            children: city
                                                                        }, city, false, {
                                                                            fileName: "[project]/Galantesjewelry/app/checkout/page.tsx",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            "Country: ",
                                                            __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$address$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["US_COUNTRY"].label
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/Galantesjewelry/app/checkout/page.tsx",
                                                        lineNumber: 535,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$product$2d$image$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductImageSrc"])(item) && // Product images are served through a local API query string; next/image localPatterns intentionally block broad query optimization.
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                    src: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$product$2d$image$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductImageSrc"])(item),
                                                    alt: item.name,
...
_s(CheckoutPage, "7Lsi4oc9/cPfJjbwDNBVrb8zLcI=", false, function() {
    return [
...
//# sourceMappingURL=Galantesjewelry_0pn2xiv._.js.map