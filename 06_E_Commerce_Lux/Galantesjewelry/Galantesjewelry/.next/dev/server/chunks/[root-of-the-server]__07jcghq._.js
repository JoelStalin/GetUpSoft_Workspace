...
async function POST(request) {
    try {
        ...
        // Tax calculation: 18% ITBIS for Dominican Republic, 7% for Florida (US)
        let taxRate = 0;
        const country = destination.country.trim();
        const isDR = country === 'Dominican Republic' || country === 'República Dominicana' || country === 'Republica Dominicana';
        const isFL = country === 'United States' && destination.state.toUpperCase() === 'FL';
        if (isDR) {
            taxRate = 0.18;
        } else if (isFL) {
            taxRate = 0.07;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07jcghq._.js.map