    ...
    async function call(model, method, payload = {}, options = {}) {
        ...
        for(let attempt = 0; attempt <= maxRetries; attempt++){
            ...
            try {
                ...
                if (!response.ok) {
                    throw new OdooRequestError(body?.message || `Odoo JSON-2 request failed with status ${response.status}.`, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0m4clp0._.js.map