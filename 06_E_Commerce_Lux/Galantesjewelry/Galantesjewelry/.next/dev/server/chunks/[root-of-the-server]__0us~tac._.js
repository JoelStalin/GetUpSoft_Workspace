...
"[project]/Galantesjewelry/lib/db.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function performInit() {
    ...
    try {
        ...
        const odooSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$odoo$2d$cms$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loadCmsSnapshotFromOdoo"])();
...
async function cleanupRemovedManagedImages(previousUrls, currentData) {
    ...
    for (const removedUrl of removedUrls){
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteManagedImage"])(removedUrl);
        } catch (error) {
...
async function updateSettings(updates) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$odoo$2d$cms$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncCmsSnapshotToOdoo"])(data);
    await writeDB(data);
...
"[project]/Galantesjewelry/lib/shipping/fedex.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function findMoney(value, depth = 0) {
    if (!value || depth > 4) {
        return null;
    }
...
function buildFedExRequestBody(address, pkg, accountNumber) {
    return {
        accountNumber: {
            value: accountNumber
        },
            ...
            requestedPackageLineItems: [
                {
                    ...
                    ...buildDimensions(pkg) ? {
                        dimensions: buildDimensions(pkg)
                    } : {}
                }
            ]
        }
...
function humanizeServiceType(serviceType, fallback = 'FedEx Shipping') {
    if (!serviceType) {
        return fallback;
    }
    const labelMap = {
    ...
    return serviceType.split('_').filter(Boolean).map((part)=>part.charAt(0) + part.slice(1).toLowerCase()).join(' ');
}
function estimateTransitDays(serviceType) {
    const transitMap = {
        FEDEX_GROUND: 4,
...
function toShippingRate(detail, pkg, insurance) {
...
async function fetchJson(url, init, timeoutMs = DEFAULT_TIMEOUT_MS) {
    ...
    try {
        ...
        if (!response.ok) {
            const errorMessage = typeof parsed === 'object' && parsed && 'error' in parsed ? JSON.stringify(parsed) : text || `HTTP ${response.status}`;
...
async function getAccessToken(config) {
    ...
    cachedTokenPromise = (async ()=>{
        const tokenResponse = await fetchJson(`${config.baseUrl}/oauth/token`, {
            method: 'POST',
            headers: {
...
function resetFedExCacheForTests() {
    cachedToken = null;
    cachedTokenPromise = null;
}
async function getFedExRates(address, pkg, insurance = 0) {
    ...
    try {
        ...
        const response = await fetchJson(`${config.baseUrl}/rate/v1/rates/quotes`, {
            method: 'POST',
            headers: {
        ...
        const normalized = details.map((detail)=>toShippingRate(detail, pkg, insurance)).filter((rate)=>Boolean(rate)).sort((left, right)=>left.price - right.price);
        if (normalized.length > 0) {
            return [
                normalized[0]
            ];
...
"[project]/Galantesjewelry/lib/shipping/engine.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$shipping$2f$fedex$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Galantesjewelry/lib/shipping/fedex.ts [app-route] (ecmascript)");
;
const DEFAULT_ORIGIN = {
    street: '82681 Overseas Highway',
    city: 'Islamorada',
...
class ShippingEngine {
    static async getRates(address, pkg) {
    ...
    static async fetchUSPS(address, pkg, insurance) {
    ...
    static async fetchUPS(address, pkg, insurance) {
    ...
    static async fetchFedEx(address, pkg, insurance) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$shipping$2f$fedex$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFedExRates"])(address || DEFAULT_ORIGIN, pkg, insurance);
    }
}
}),
"[project]/Galantesjewelry/lib/shipping-settings.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "DEFAULT_SHIPPING_CITIES",
    ()=>DEFAULT_SHIPPING_CITIES,
    "getAllowedShippingCities",
    ()=>getAllowedShippingCities,
    "getShippingCityCatalog",
    ()=>getShippingCityCatalog,
    "isShippingCityAllowed",
    ()=>isShippingCityAllowed,
    "normalizeCityList",
    ()=>normalizeCityList,
...
function sanitizeShippingSettings(settings) {
...
function getShippingCityCatalog(settings) {
    return normalizeCityList(settings.shipping_cities);
}
function getAllowedShippingCities(settings) {
...
function isShippingCityAllowed(settings, city) {
...
function validateShippingCity(settings, city) {
    const normalizedCity = typeof city === 'string' ? normalizeCityValue(city) : '';
    ...
    if (!normalizedCity) {
        if (configuredCities.length > 0) {
            return {
                valid: false,
                message: 'Select a shipping city from the list.'
            };
        }
        return {
            valid: false,
...
"[project]/Galantesjewelry/lib/tax.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Galantesjewelry/app/api/cart/summary/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Galantesjewelry/lib/db.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$shipping$2f$engine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Galantesjewelry/lib/shipping/engine.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$shipping$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Galantesjewelry/lib/shipping-settings.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$tax$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Galantesjewelry/lib/tax.ts [app-route] (ecmascript)");
;
;
;
;
...
const cartSummarySchema = __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    subtotal: __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().nonnegative(),
    itemCount: __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().nonnegative().optional(),
    destination: __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        street: __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional().default(''),
        city: __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional().default(''),
        state: __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional().default(''),
        zip: __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional().default(''),
        country: __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional().default('United States')
    }).optional()
});
...
function valueFromRelation(value) {
    if (Array.isArray(value)) {
        return value[1] || '';
    }
...
function toShippingAddress(record) {
    const street = [
        record.street,
        record.street2
...
async function resolveDestinationAddress() {
    ...
    if (user) {
        ...
        if (partnerId) {
            const addresses = await __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$odoo$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OdooService"].getPartnerAddresses(partnerId);
    ...
    const settings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSettings"])();
    return {
...
async function POST(request) {
    try {
        ...
        const cityCheck = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$shipping$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateShippingCity"])(settings, destination.city);
        if (!cityCheck.valid) {
        ...
        const rates = await __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$shipping$2f$engine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ShippingEngine"].getRates(destination, {
            weightLbs: 1,
            value: subtotal
        });
        const shippingRate = rates.find((rate)=>rate.carrier !== 'pickup') || rates[0] || null;
        const shippingTotal = shippingRate?.price || 0;
        const tax = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$lib$2f$tax$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculateTaxBreakdown"])({
            subtotal,
            shippingTotal,
            destination
        });
        ...
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].ZodError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Galantesjewelry$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid cart summary payload'
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0us~tac._.js.map