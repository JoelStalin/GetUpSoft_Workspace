...
class C:
    ...
    BORDER    = "#2D3139"
    BORDER_B  = "#3D414A"
    BORDER_A  = "#A5B4FC" # Indigo Pastel accent
    PRI       = "#A5B4FC" # Indigo Pastel
    PRI_DIM   = "#6366F1"
    PRI_GHO   = "rgba(165, 180, 252, 0.1)"
    ACC       = "#99F6E4" # Mint Pastel
    ACC2      = "#5EEAD4"
    GREEN     = "#99F6E4"
    GREEN_D   = "#2DD4BF"
    RED       = "#FDA4AF" # Rose Pastel
    MUTED_C   = "#64748B"
    TEXT      = "#E2E8F0"
    TEXT_DIM  = "#94A3B8"
    TEXT_MED  = "#CBD5E1"
    ...
    def paintEvent(self, _):
        ...
        if self._face_px:
            ...
            p.drawText(QRectF(cx - 80, cy - 14, 160, 28),
                       Qt.AlignmentFlag.AlignCenter, "O.R.C.A")
...
class LogWidget(QTextEdit):
    ...
    def _next(self):
        ...
        elif tl.startswith("Orca:"): self._tag = "ai"
...
_FILE_ICONS = {
    ...
    "code":    ("💬»", "#ffcc00"), "archive": ("ðŸ“¦", "#ff8844"),
    "pptx":    ("ðŸ“Š", "#ff6622"), "text":    ("ðŸ“ƒ", "#aaaaaa"),
    "data":    ("🔧", "#88ddff"), "unknown": ("ðŸ“Ž", "#888888"),
}
_EXT_TO_CAT = {
...
class FileDropZone(QWidget):
    ...
    def _browse(self):
        path, _ = QFileDialog.getOpenFileName(
            self, "Select a file for Orca", str(Path.home()),
            "All Files (*.*);;"
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        super().__init__()
        self.setWindowTitle("ORCA — Enterprise AI Orchestrator")
    ...
    def _build_header(self) -> QWidget:
        ...
        title = QLabel("O.R.C.A")
        title.setAlignment(Qt.AlignmentFlag.AlignCenter)
        title.setFont(QFont("Courier New", 17, QFont.Weight.Bold))
        title.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        mid.addWidget(title)
        sub = QLabel("Operational Real-time Cognitive Orchestrator")
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addStretch()
        lay.addWidget(_fl("GetUpSoft Systems  ·  ORCA CORE  ·  CLASSIFIED"))
        lay.addStretch()
        lay.addWidget(_fl("Â© GETUPSOFT", C.PRI_DIM))
        return w
    ...
    def _on_file_selected(self, path: str):
        ...
        self._file_hint.setText(f"{icon}  {p.name}  ·  {size}  ·  Tell Orca what to do with it")
    ...
    def _on_setup_done(self, key: str, os_name: str):
        ...
        if self._overlay:
            ...
            self._overlay = None
        self._apply_state("LISTENING")
        self._log.append_log(f"SYS: Initialised. OS={os_name.upper()}. Orca online.")
