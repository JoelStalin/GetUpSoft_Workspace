...
## Historial heredado de `main` (fusion de historiales no relacionados, 2026-09-17)

El siguiente bloque proviene de la rama `main` (estructura pre-reorganizacion,
193K archivos), fusionada aqui via `git merge --allow-unrelated-histories`
para habilitar el PR contra `main`. Se conserva integro como registro
historico -- no se elimina ni se reescribe.
