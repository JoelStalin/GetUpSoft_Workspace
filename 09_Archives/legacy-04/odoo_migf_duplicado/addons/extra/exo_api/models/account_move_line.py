...
class AccountMoveLineInherit(models.Model):
    ...
    pending_benefit_id = fields.Many2one(
        'partner.benefit.pending',
        string='Beneficio pendiente',
        ondelete='set null',
        index=True,
        help='Registro de beneficio recurrente pendiente que originó esta línea.'
    )
    #test
