...
Selecciona según disponibilidad (Community/Enterprise):
- **Contacts** (base)
- **Accounting / Invoicing**
- **Website + Portal**
- **Subscriptions** (si se usará facturación recurrente nativa)
- **Helpdesk** (o módulo custom de tickets si Community)
