...
Snapshot local obtenido desde el ambiente `jabiya` y refactorizado localmente como variante `GetUpSoft`.

Fuente remota:

- host: `jabiya`
- ruta original: `/opt/odoo-docker/addons/neo_do_localization`
...
- Este directorio ya no replica literalmente el nombre del origen: fue renombrado a `getupsoft_do_localization` junto con sus modulos internos para dejar una variante coherente con el branding solicitado.
