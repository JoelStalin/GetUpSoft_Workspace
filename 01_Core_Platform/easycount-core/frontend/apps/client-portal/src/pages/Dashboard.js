...
export function DashboardPage() {
    return (_jsxs("div", { className: "space-y-8", children: [_jsxs("header", { className: "space-y-1", children: [_jsx("h1", { className: "text-2xl font-semibold text-white", children: "Resumen del tenant" }), _jsx("p", { className: "text-sm text-slate-300", children: "Seguimiento operativo de env\u00C3\u00ADos DGII, planes tarifarios y controles de aprobaci\u00C3\u00B3n." })] }), _jsx("section", { className: "grid gap-4 md:grid-cols-3", children: KPIS.map((kpi) => (_jsx(CardKPI, { ...kpi }, kpi.title))) }), _jsxs("section", { className: "space-y-3 text-sm text-slate-300", children: [_jsx("h2", { className: "text-lg font-semibold text-white", children: "Pr\u00C3\u00B3ximas acciones" }), _jsxs("ul", { className: "space-y-2", children: [_jsx("li", { children: "\u00E2\u20AC\u00A2 Subir nuevo certificado .p12 antes de que expire el actual." }), _jsx("li", { children: "\u00E2\u20AC\u00A2 Revisar aprobaciones comerciales pendientes (ACECF)." }), _jsx("li", { children: "\u00E2\u20AC\u00A2 Ejecutar conciliaci\u00C3\u00B3n con Odoo para facturas del mes." })] })] })] }));
}
