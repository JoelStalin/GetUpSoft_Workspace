    ...
    <div className="mx-auto max-w-7xl px-6 py-16">
      <header className="max-w-3xl space-y-4">
        ...
        <p className="text-lg text-slate-600">
          EasyCounting organiza la operacion sobre portales separados, control de permisos, evidencia funcional y una base preparada para integraciones contables y fiscales.
        </p>
      </header>
