    ...
    const cards = [
        {
            ...
            value: dashboard ? dashboard.tenantCount.toLocaleString("es-DO") : "â€¦",
        ...
        },
        {
            ...
            value: dashboard ? dashboard.invoiceCount.toLocaleString("es-DO") : "â€¦",
