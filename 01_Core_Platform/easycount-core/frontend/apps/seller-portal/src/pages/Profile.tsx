        ...
        <article className="rounded-xl border border-slate-800 bg-slate-900/40 p-5">
          ...
          <dl className="mt-4 space-y-3 text-sm text-slate-300">
            <div>
              ...
              <dd className="font-medium text-slate-100">{profile?.accountName ?? "Cargandoâ€¦"}</dd>
            </div>
            <div>
              <dt className="text-slate-500">Slug</dt>
              <dd className="font-mono text-xs text-slate-300">{profile?.accountSlug ?? "â€”"}</dd>
            </div>
            <div>
              <dt className="text-slate-500">Correo</dt>
              <dd className="font-medium text-slate-100">{profile?.userEmail ?? "â€”"}</dd>
            </div>
            <div>
              <dt className="text-slate-500">Rol</dt>
              <dd className="font-medium text-slate-100">{profile?.role ?? "â€”"}</dd>
            </div>
          </dl>
        </article>
        ...
        <article className="rounded-xl border border-slate-800 bg-slate-900/40 p-5">
          ...
          <dl className="mt-4 space-y-3 text-sm text-slate-300">
            <div>
              ...
              <dd className="font-medium text-slate-100">{dashboard?.tenantCount ?? "â€”"}</dd>
            </div>
            <div>
              <dt className="text-slate-500">Comprobantes visibles</dt>
              <dd className="font-medium text-slate-100">{dashboard?.invoiceCount ?? "â€”"}</dd>
            </div>
            <div>
              <dt className="text-slate-500">Pendientes</dt>
              <dd className="font-medium text-slate-100">{dashboard?.pendingCount ?? "â€”"}</dd>
            </div>
            <div>
