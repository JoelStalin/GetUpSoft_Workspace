...
function PlanCard({ plan, currentPlanId, pendingPlanId, onSelect, isLoading }) {
    ...
    return (_jsxs("div", { className: "rounded-xl border border-slate-800 bg-slate-900/40 p-5 text-sm text-slate-200", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "text-lg font-semibold text-white", children: plan.name }), _jsxs("span", { className: "text-sm font-semibold text-primary", children: [Number(plan.precio_mensual).toLocaleString("es-DO", { style: "currency", currency: "DOP" }), " / mes"] })] }), plan.descripcion ? _jsx("p", { className: "mt-2 text-xs text-slate-400", children: plan.descripcion }) : null, _jsxs("div", { className: "mt-4 grid gap-2 text-xs text-slate-300", children: [_jsxs("p", { children: ["Documentos incluidos: ", plan.documentos_incluidos] }), _jsxs("p", { children: ["Precio por documento: ", Number(plan.precio_por_documento).toLocaleString("es-DO", { style: "currency", currency: "DOP" })] }), _jsxs("p", { children: ["Max facturas/mes: ", plan.max_facturas_mes] }), _jsxs("p", { children: ["Max facturas/cliente/mes: ", plan.max_facturas_por_receptor_mes] }), _jsxs("p", { children: ["Monto max por factura: ", Number(plan.max_monto_por_factura).toLocaleString("es-DO", { style: "currency", currency: "DOP" })] })] }), _jsx("button", { type: "button", onClick: onSelect, disabled: isLoading || isCurrent || isPending, className: "mt-4 w-full rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground disabled:cursor-not-allowed disabled:bg-slate-700", children: isLoading ? "Procesando..." : actionLabel })] }));
}
