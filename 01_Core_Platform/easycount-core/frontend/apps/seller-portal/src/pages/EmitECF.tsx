    ...
    <div className="grid gap-6 xl:grid-cols-[1.1fr,0.9fr]">
      <Card>
        <CardHeader className="space-y-2">
          ...
          <p className="text-sm text-slate-300">
            El socio solo puede generar documentos demo para clientes que tenga asignados con permiso de emisiÃ³n.
          </p>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="space-y-2">
          ...
          <p className="text-sm text-slate-300">Esta superficie estÃ¡ limitada por rol y por asignaciÃ³n de clientes.</p>
        </CardHeader>
        <CardContent className="space-y-4 text-sm text-slate-300">
          <ul className="space-y-2">
            <li>â€¢ `partner_reseller` y `partner_operator` pueden emitir solo si la asignaciÃ³n habilita `canEmit`.</li>
            <li>â€¢ `partner_auditor` conserva acceso de lectura, sin emisiÃ³n.</li>
            <li>â€¢ Los documentos se crean en estado `SIMULADO` dentro del backend demo.</li>
          </ul>
