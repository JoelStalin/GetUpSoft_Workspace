    ...
    <div className="space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-sm text-slate-300">
          Configura valores fijos, porcentajes y tramos escalonados siguiendo las fÃ³rmulas descritas en la guÃ­a 13.
        </p>
      </header>
      {createPlan.isError ? (
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end gap-2">
          ...
          >
            {createPlan.isPending ? "Guardandoâ€¦" : "Guardar plan"}
          </button>
        </div>
      </form>
    </div>
