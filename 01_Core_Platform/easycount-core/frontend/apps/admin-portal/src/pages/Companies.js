...
export function CompaniesPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("header", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-semibold text-white", children: "Compa\u00C3\u00B1\u00C3\u00ADas" }), _jsx("p", { className: "text-sm text-slate-300", children: "Gestiona tenants, ambientes DGII y certificados." })] }), _jsx("button", { onClick: () => setOpen(true), className: "rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground hover:bg-primary/90", children: "Crear compa\u00C3\u00B1\u00C3\u00ADa" })] }), tenantsQuery.isError ? (_jsx("div", { className: "rounded-xl border border-rose-900/60 bg-rose-950/30 p-4 text-sm text-rose-200", children: "No se pudo cargar el listado de compa\u00C3\u00B1\u00C3\u00ADas." })) : null, _jsx(DataTable, { data: rows, columns: [
                    {
                        header: "CompaÃ±Ã­a",
