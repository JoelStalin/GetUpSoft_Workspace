{
    ...
    'summary': 'POS Kitchen Screen facilita el envío automático de ciertos pedidos a la cocina. Permite personalizar la vista de pedidos para que el personal pueda ver la información más importante.',
    'description': """
The POS Kitchen Screen in Odoo 18 is a feature that allows restaurant staff to view and manage orders in real-time from the kitchen. This screen provides a clear and organized display of all active orders, enabling kitchen staff to prioritize and manage their tasks efficiently. The POS Kitchen Screen in Odoo 18 also allows for the customization of order views, so that staff can see the information that is most important to them. Additionally, this feature facilitates communication between front-end and back-end staff, enabling them to work together seamlessly and provide a better dining experience for customers.
    """,
