...
class AccountAccount(models.Model):
    ...
    account_fiscal_type = fields.Selection(
        [
            ...
            (
                "A27",
                "A27 - ITBIS Pagado en Importaciones para la Producción de Bienes Exentos",
            ),
            ...
            (
                "I04",
                "I04 - Ingresos por ventas de bienes o servicios exentos por destino",
            ),
            (
                "I13",
                "I13 - Operaciones gravadas por ventas de Activos Depreciables"
                "(categoría 2 y 3)",
            ),
            (
                "I28",
                "I28 - Saldos Compensables Autorizados (Otros Impuestos) y/o Reembolsos",
            ),
            ("I35", "I35 - Recargos"),
        ...
        copy=False,
        tracking=True,  # Permite rastrear cambios
    )

    isr_retention_type = fields.Selection(
        selection=lambda self: self.env["account.tax"]._get_isr_retention_type() or [],
        string="ISR Withholding Type",
        tracking=True,  # Permite rastrear cambios en Odoo 18
    )
