...
CSV_DATA = {
    ...
    'test_fiscal_position': (
        ...
        '"test_fiscal_position","Fiscal Position","base.be","1","test_tax_3_template","test_tax_4_template"\n'
    ),
}
...
class TestChartTemplate(AccountTestInvoicingCommon):
    ...
    def test_update_taxes_creation(self):
        ...
        def local_get_data(self, template_code):
            ...
            data['account.fiscal.position']['test_fiscal_position']['tax_ids'].extend([
                Command.create({
    ...
    def test_parsed_csv_submodel_being_updated(self):
        ...
        with patch('odoo.addons.account.models.chart_template.file_open',
                   side_effect=lambda *args: io.StringIO(CSV_DATA['test_fiscal_position'])):
