...
class PosClientPrinter(models.Model):
    ...
    name = fields.Char(string='Nombre de Impresora', required=True)
    ip_address = fields.Char(string='Dirección IP / Host', help="IP o Host donde corre el agente")
    port = fields.Integer(string='Puerto', default=8069)
