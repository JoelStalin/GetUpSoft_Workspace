...
const menuItems = [
  ...
  { icon: Zap, label: "Automation Bots", path: "/automation" },
];
  ...
  return (
    <>
      ...
      <SidebarInset className="bg-background">
        {!isMobile && title && (
          <div className="flex h-16 items-center px-8 border-b border-border/50 bg-background/50 backdrop-blur-sm sticky top-0 z-40">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-3">
                <div className="flex flex-col gap-1">
                  <span className="tracking-tight text-foreground font-bold uppercase">
                    {title || activeMenuItem?.label ?? "Menu"}
                  </span>
                </div>
              </div>
            </div>
