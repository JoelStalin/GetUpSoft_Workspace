...
setup(
  name='tinderbotj',         # How you named your folder
  packages=find_packages(),   # Include helpers and assistant subpackages
  ...
  url='https://github.com/frederikme/tinderbotj',   # Provide either the link to your github or to your website
  download_url='https://github.com/frederikme/tinderbotj/archive/1.6.tar.gz',    # I explain this later on
  keywords=['Tinder', 'Automation', 'bot'],   # Keywords that define your project best
  install_requires=['selenium', 'webdriver-manager', 'requests', 'keyboard'],
