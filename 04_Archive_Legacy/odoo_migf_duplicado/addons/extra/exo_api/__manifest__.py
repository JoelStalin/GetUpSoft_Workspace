{
    ...
    'data': [
        ...
        'views/hr_payslip_line/hr_payslip_xlsx.xml',
        ...
        'views/benefits_and_discounts/benefit_cron.xml',
        'views/benefits_and_discounts/benefit_cron.xml',
        'views/benefits_and_discounts/partner_benefit_pending_views.xml',
        ...
        'views/transporter_discount_report/transporter_discount_report_views.xml',
        'views/transporter_discount_report/transporter_report_wizard_views.xml',
        'security/transporter_discount_report/ir.model.access.csv',
