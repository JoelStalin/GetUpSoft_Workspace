...
class AccountLineDeletedLoad(models.Model):
    ...
    def create_deleted(self, account_lines_loads):
        for record in account_lines_loads:
            item = {
                ...
                'account_line_id': (
                    f"{record.account_line_id.id} - {record.account_line_id.name}"
                    if record.account_line_id else False
                ),
                'account_move_id': (
                    f"{record.account_move_id.id} - {record.account_move_id.name}"
                    if record.account_move_id else False
                ),
