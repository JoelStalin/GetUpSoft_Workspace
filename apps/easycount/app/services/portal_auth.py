...
PortalKind = Literal["admin", "client", "seller", "unified"]
...
class PortalAuthService:
    ...
    def ensure_portal_access(self, *, user: User, portal: PortalKind) -> None:
        if portal == "unified":
            # El portal unificado permite el acceso a todos los roles válidos,
            # la segregación se maneja dinámicamente en el frontend.
            return
