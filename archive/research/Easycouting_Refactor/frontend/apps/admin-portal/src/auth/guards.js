...
export function RequireScope({ scope, children }) {
    ...
    if (currentScope !== scope) {
        return _jsx(ForbiddenState, { description: "Esta vista solo est\u00E1 disponible para otro \u00E1mbito de usuario." });
    }
    return _jsx(_Fragment, { children: children });
}
export function RequireMFA({ children, mfaCompleted }) {
    if (!mfaCompleted) {
        return _jsx(ForbiddenState, { description: "Completa el segundo factor para continuar." });
    }
    return _jsx(_Fragment, { children: children });
}
